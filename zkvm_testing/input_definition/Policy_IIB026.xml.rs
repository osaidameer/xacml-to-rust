...
pub struct Inputs {
    ...
    pub access_subject_request_time: DateTime<FixedOffset>,
    pub resource_resource_id: String,
    pub action_action_id: String,
}

impl Inputs {
    pub fn new(access_subject_subject_id: String, access_subject_request_time: DateTime<FixedOffset>, resource_resource_id: String, action_action_id: String) -> Self {
        Self {
