...
impl Inputs {
    pub fn new(access_subject_subject_id: String, access_subject_some_attribute: String, resource_resource_id: String, action_action_id: String) -> Self {
        Self {
            access_subject_subject_id,
            access_subject_some_attribute,
