...
fn evaluate_target_policy_rule(inp: &Inputs) -> bool {
    (((CN=Julius Hibbert,O=Medi Corporation,C=US == inp.access_subject_subject_id)) && (("http://medico.com/record/patient/BartSimpson" == inp.resource_resource_id)) && (("read" == inp.action_action_id) || ("write" == inp.action_action_id)))
}
