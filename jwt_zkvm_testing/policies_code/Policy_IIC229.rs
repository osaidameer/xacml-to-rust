...
fn evaluate_cond_policy_rule(inp: &Inputs) -> bool {
    (vec![
        &"BQADgY0AMIGJAoGBAK/yHi+g4nRQ3qKrCZGRYY2feUmVrM0QKOzAdrVnP7vhjamt6oDi2mX00w2L".to_string(),
        &"BQADgY0AMIGJAoGBFK/yHi+g4nRQ3qKrCZGRYY2feUmVrM0QKOzAdrVnP7vhjamt6oDi2mX00w2L".to_string(),
    ])
    .into_iter()
    .collect::<HashSet<_>>()
    .is_subset(&inp.access_subject_test_attr.iter().collect::<HashSet<_>>())
}
